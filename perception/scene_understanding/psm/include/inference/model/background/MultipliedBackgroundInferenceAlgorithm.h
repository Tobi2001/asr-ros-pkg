...
namespace ProbabilisticSceneRecognition {
  ...
  /**
   * Implementation of the abstract BackgroundInferenceAlgorithm class. It evaluates all background scene objects and multiplies the results.
   *
   * @author Joachim Gehrung
   * @version See SVN
   */
  class MultipliedBackgroundInferenceAlgorithm : public BackgroundInferenceAlgorithm {
  public:
