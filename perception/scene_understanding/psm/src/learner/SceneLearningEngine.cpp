...
namespace ProbabilisticSceneRecognition {
  ...
  {
    ROS_INFO_STREAM("Scene model learner: Extracting PbdSceneGraph messages from rosbag file: " << pPbdSceneGraphsBagPath);
    ...
    if(!pbdSceneGraphView.size())
      ROS_WARN_STREAM("No PbdSceneGraph messages exist in " << pPbdSceneGraphsBagPath << " on topic " << mPbdSceneGraphListener.getTopic() << ".");
